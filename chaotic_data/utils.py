...
class SlidingWindowDataset(Dataset):
    ...
    def __init__(self, tensor_data: torch.tensor , window_size:int):
        """
    ...
    def sliding_windows_shift_to(self, tensor_data, window_size)-> torch.Tensor :#, tensor_data, window_size) -> torch.Tensor:
        """
